  ...
  return (
    <section id='about' className="w-full md:px-20 h-auto py-20 pb-20 px-5 bg-secondary mx-auto text-offblack/80 dark:bg-dark-secondary dark:text-secondary " >
      <div className='flex flex-col gap-8 max-w-7xl mx-auto'>
        ...
        <p className="text- landing-para leading-8" >I'm MD Sohail, a  Frontend Developer passionate about crafting fast, accessible and responsive web applications using 
        ...
        <p className="text- landing-para leading-8">

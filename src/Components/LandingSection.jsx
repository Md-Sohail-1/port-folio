...
const LandingSection = () => {
  ...
  return (
    <main className="relative pt-16 md:pt-0 bg-white  text-offblack dark:text-secondary dark:bg-offblack w-full  min-h-[calc(100dvh-64px)] md:px-15 md:grid md:place-content-center md:py-0 px-5 " >
      <div className='min-h-[calc(100dvh - 64px)] max-w-7xl mx-auto  flex gap-12 md:gap-20 flex-col md:flex-row md:items-center md:justify-between pb-10 md:pb-0 '>

...
const LandingSection = () => {
  return (
    <div className="relative bg-white text-offblack dark:text-offwhite/90 dark:bg-dark-secondary w-full md:h-screen min-h-[calc(100vh-64px)] flex flex-col md:flex-row md:items-center md:justify-between py-20 md:px-15  md:py-0 px-5 gap-12 md:gap-20" >
      <div className="flex flex-col gap-4 self start md:w-1/2" >
        ...
        <button role="button" className="mr-auto w-content text-sm text-white/90 bg-primary dark:text-offblack/80 shadow-sm text-shadow-md hover:bg-dark-primary dark:bg-light-primary hover:dark:bg-secondary px-6 py-3 md:py-3 rounded-md transition-all ease-in-out duration-200" >Download Resume</button>
      </div>
      <div className='landing-image bg-white rounded-full'>
        <img 
          ...
          height="100%"
          width="100%"
          className=" mix-blend-multiply  rounded-full aspect-1/1 dark:brightness-90 object-cover"
        />
      </div>
    </div>
  )
